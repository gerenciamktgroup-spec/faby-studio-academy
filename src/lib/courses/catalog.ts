...
export const COURSE_CATALOG: Record<string, CourseData> = {
  'extensiones-de-pestanas': {
    ...
    tagline: 'Formación profesional integral en técnica clásica pelo a pelo, volumen ruso, visagismo y diseño de cejas con henna, lifting y depilación con hilo.',
    description: 'Programa formativo de referencia en estética de la mirada. Combina rigor técnico y bioseguridad ocular con el dominio del visagismo, diseño con henna, lifting, laminado de cejas, depilación con hilo (threading) y la creación de abanicos de volumen ruso.',
    highlights: [
      'Técnica clásica 1:1 y abanicado manual 2D a 6D',
      'Visagismo con henna, laminado de cejas y depilación con hilo (threading)',
      'Lifting de pestañas y tintado profesional',
  ...
  'cosmetologia-facial': {
    ...
    tagline: 'Formación clínica integral en diagnóstico cutáneo, protocolos de Hidrafacial, peelings químicos, dermapen y rejuvenecimiento facial.',
    description: 'El programa más avanzado en estética facial. Conviértete en experta en Hidrafacial y aparatología de última generación. Domina el análisis de biotipos cutáneos, protocolos de renovación dérmica, cierre de poros y luminosidad inmediata.',
    highlights: [
      'Protocolo paso a paso de Hidrafacial y limpieza profunda en cabina',
      'Diagnóstico clínico de biotipos y fototipos de Fitzpatrick',
      'Química cosmética: Ácidos (AHA/BHA), Retinoides y Péptidos',
      'Aparatología: Espátula ultrasónica, radiofrecuencia y Dermapen',
      'Certificado digital con firma criptográfica SHA-256',
    ],
    skillsGained: [
